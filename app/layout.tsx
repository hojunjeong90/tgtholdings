...
const SITE_NAME = 'TGT Holdings';
const SITE_DESCRIPTION = '글로벌 통화 지표, 환율, 금리 및 투자 시그널을 실시간으로 분석하는 투자 인텔리전스 플랫폼';
...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'TGT Holdings' }],
  creator: 'TGT Holdings',
  publisher: 'TGT Holdings',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
