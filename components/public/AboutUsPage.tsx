  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24 lg:py-28 border-b border-border/50">
        <div className="content-shell">
          <div className="flex items-baseline justify-between mb-8 md:mb-12">
            <h2 className="font-display text-huge font-semibold tracking-[-0.04em] leading-[0.98]">Firm Profile</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            {profile.map((item) => (
              ...
              >
                <p className="label-mono text-primary/70">
                  {item.label}
                </p>
      ...
      <section className="py-16 md:py-24 lg:py-28 border-b border-border/50">
        <div className="content-shell">
          <div className="flex items-baseline justify-between mb-8 md:mb-12">
            <h2 className="font-display text-huge font-semibold tracking-[-0.04em] leading-[0.98]">System Architecture</h2>
            <span className="label-mono text-muted-foreground/50">
      ...
      <section className="py-16 md:py-24 lg:py-28 border-b border-border/50">
        <div className="content-shell">
          <h2 className="font-display text-huge font-semibold tracking-[-0.04em] leading-[0.98] mb-8 md:mb-12">What We Believe</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            {values.map((v) => (
              <div key={v.title} className="p-6 md:p-8 rounded-xl border border-border/60 bg-muted/20">
                <h3 className="font-display font-semibold text-lg md:text-xl tracking-[-0.025em] mb-2 md:mb-3">{v.title}</h3>
      ...
      <section className="py-16 md:py-24 lg:py-28">
        <div className="content-shell">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div>
              <h2 className="font-display text-huge font-semibold tracking-[-0.04em] leading-[0.98] mb-3">Build the infrastructure with us.</h2>
