    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border/50 py-16 md:py-24 lg:py-28">
        <div className="content-shell">
          ...
          <h1 className="career-display mb-6 md:mb-8">
            Career
          </h1>
      ...
      <section className="py-16 md:py-24 lg:py-28 border-b border-border/50">
        <div className="content-shell">
          <h2 className="font-display text-[clamp(2.25rem,5vw,4.5rem)] font-semibold tracking-[-0.05em] leading-[0.93] mb-8 md:mb-12">What We Look For</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {traits.map((t) => (
              <div key={t.title} className="flex gap-4 md:gap-5">
                <span className="text-primary mt-1 flex-shrink-0">—</span>
                <div>
                  <h3 className="font-display font-semibold text-xl md:text-2xl tracking-[-0.03em] mb-1.5 md:mb-2">{t.title}</h3>
      ...
      <section className="py-16 md:py-24 lg:py-28 border-b border-border/50">
        <div className="content-shell">
          <div className="flex items-baseline justify-between mb-8 md:mb-12">
            <h2 className="font-display text-[clamp(2.25rem,5vw,4.5rem)] font-semibold tracking-[-0.05em] leading-[0.93]">Open Roles</h2>
            <span className="label-mono inline-flex items-center gap-1.5 text-primary/80">
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-3 mb-2">
                    <h3 className="font-display text-xl md:text-2xl font-semibold tracking-[-0.03em]">{role.title}</h3>
                    <span className="label-mono text-muted-foreground/60">{role.type}</span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {role.tags.map((tag) => (
                      <span
                        key={tag}
                        className="label-mono px-2 py-0.5 rounded border border-border/50 text-muted-foreground/70 bg-muted/20"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      <section className="py-16 md:py-24 lg:py-28">
        <div className="content-shell">
          <div className="max-w-xl">
            <h2 className="font-display text-[clamp(2.25rem,5vw,4.5rem)] font-semibold tracking-[-0.05em] leading-[0.93] mb-5">Reach Out Anyway</h2>
