          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            {channels.map((c) => (
              <div key={c.label} className="p-6 md:p-8 rounded-xl border border-border/60 bg-muted/20">
                <p className="label-mono text-primary mb-3 md:mb-4">{c.label}</p>
                <a
                  href={`mailto:${c.email}`}
      ...
      <section className="py-16 md:py-24 lg:py-28">
        <div className="content-shell">
          <div className="max-w-2xl">
            <h2 className="font-display text-huge font-semibold tracking-[-0.04em] leading-[0.98] mb-5 md:mb-6">A Note on Response Times</h2>
