  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-16 gap-y-8 md:gap-y-12">
            {steps.map((s) => (
              <div key={s.index} className="flex gap-4 md:gap-6">
                ...
                <div>
                  <h3 className="font-display font-semibold text-lg md:text-xl tracking-[-0.025em] mb-2">{s.title}</h3>
      ...
      <section className="py-16 md:py-24 lg:py-28">
        <div className="content-shell">
          <h2 className="font-display text-huge font-semibold tracking-[-0.04em] leading-[0.98] mb-8 md:mb-12">Guiding Principles</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            {principles.map((p) => (
              <div key={p.label} className="p-5 md:p-6 rounded-xl border border-border/60 bg-muted/20">
                <h4 className="font-display font-semibold text-lg tracking-[-0.025em] mb-2">{p.label}</h4>
